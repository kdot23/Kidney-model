...
greedyO = subset(greedyA, grepl('I', V1) & V25 == .9)
...
greedyNO = subset(greedyA, grepl('I', V1) & V25 != .9)
...
odasseO = subset(odasseA, grepl('I', V1) & V26 == .9)
...
odasseNO = subset(odasseA, grepl('I', V1) & V26 != .9)
