...
boxplot(V1~Cat, total, col='powderblue', names=c('Greedy', 'ODASSE', 'Oracle Count', 'Oracle'), main='Total Expected Graft Survival by Algorithm', ylab='Total Expected Graft Survival', boxlwd=2)
